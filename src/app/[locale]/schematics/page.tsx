...
import { Button, Carousel, SchematicFeed, Skeleton, TextType, ThemedImage, Typography } from "@/components";
            ...
            {HAS_EVENT && (
                <section className="relative h-[calc(100vh*0.8)] object-cover">
                    <div className="absolute top-1/3 z-3 flex w-full -translate-x-2 -translate-y-1/4 flex-col items-center">
                        <Typography.H1 className="atext-4xl translate-x-1 leading-tight font-bold text-red-500 dark:text-red-600 text-shadow-[0_0_2px,0_0_6px,0_0_12px,0_0_24px] text-shadow-red-800 dark:text-shadow-red-900 sm:text-5xl lg:text-6xl">
                    ...
                    <ThemedImage src="launching-banner.webp" layout="fill" style={{ objectFit: "cover" }} alt="Launching Banner" />
                </section>
            )}
