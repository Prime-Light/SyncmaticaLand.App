...
export function EditProjectDialog({ project, open, onOpenChange, onSuccess }: EditProjectDialogProps) {
    ...
    const { schematic: fullSchematic, isLoading: isLoadingFull } = useSchematic(project?.id ?? "");
                ...
                <form onSubmit={handleSubmit} className="flex flex-1 flex-col overflow-hidden">
                    ...
                    <Shadcn.Card>
                        <Shadcn.CardHeader>
                            ...
                            <Shadcn.CardDescription>
                                支持 .schematic, .schem, .litematic, .nbt 格式，最大 10MB。不上传则保留原文件。
                            </Shadcn.CardDescription>
                        </Shadcn.CardHeader>
                        <Shadcn.CardContent>
                            {schematicFile || project ? (
                                <div className="flex items-center gap-3 rounded-md border border-border bg-muted/50 p-4">
                                    ...
                                    <div className="flex flex-1 flex-col gap-0.5">
                                        <span className="text-base font-medium">{currentFileName}</span>
                                        {schematicFile && (
                            ...
                            <div
                                role="button"
                                tabIndex={0}
                                aria-describedby={schematicError ? "edit-schematic-file-error" : undefined}
                                ...
                                <div className="flex flex-col items-center gap-1 text-center">
                                    <p className="text-sm font-medium">点击或拖放上传新文件替换</p>
                                    <p className="text-xs text-muted-foreground">.schematic / .schem / .litematic / .nbt</p>
                                </div>
                                <input
                            ...
                            {schematicError && (
                                <p id="edit-schematic-file-error" role="alert" className="mt-2 text-sm text-destructive">
                                    {schematicError}
                                </p>
                            )}
                        </Shadcn.CardContent>
                    ...
                    <Shadcn.Card>
                        <Shadcn.CardHeader>
                            ...
                            <Shadcn.CardDescription>填写原理图的基本信息</Shadcn.CardDescription>
                        </Shadcn.CardHeader>
                        <Shadcn.CardContent>
                            <Shadcn.FieldGroup>
                                <Shadcn.Field>
                                ...
                                <Shadcn.Field>
                                    ...
                                    <Shadcn.Select value={categoryId} onValueChange={setCategoryId} disabled={isCategoriesLoading || isLoadingFull}>
                                        <Shadcn.SelectTrigger id="edit-category">
                                            <Shadcn.SelectValue placeholder={isCategoriesLoading || isLoadingFull ? "加载中..." : "选择分类"} />
                    ...
                    <div className="shrink-0 border-t bg-muted px-6 py-4 flex items-center justify-end gap-3">
