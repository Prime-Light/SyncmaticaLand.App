...
function InputOTPSlot({
    ...
    return (
        <div
            ...
            className={cn(
                "relative flex size-8 items-center justify-center border-y border-e border-input text-xs transition-all outline-none first:rounded-none first:border-s last:rounded-none aria-invalid:border-destructive data-[active=true]:z-10 data-[active=true]:border-ring data-[active=true]:ring-1 data-[active=true]:ring-ring/50 data-[active=true]:aria-invalid:border-destructive data-[active=true]:aria-invalid:ring-destructive/20 dark:bg-input/30 dark:data-[active=true]:aria-invalid:ring-destructive/40",
                className
            )}
            {...props}>
            {char}
